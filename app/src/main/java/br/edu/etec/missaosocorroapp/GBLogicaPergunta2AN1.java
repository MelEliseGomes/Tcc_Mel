...
public class GBLogicaPergunta2AN1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.gb_tela_pergunta_2a_n1);
        ...
        txtPergunta.setText(getString(R.string.texto_pergunta_2a_crianca_nivel_1));

        String altA = getString(R.string.texto_opcao_p2a_n1_a); // correta → tela L
        String altB = getString(R.string.texto_opcao_p2a_n1_b); // incorreta → tela M
        String altC = getString(R.string.texto_opcao_p2a_n1_c); // incorreta → tela N
        ...
        botao_voltar.setOnClickListener(v -> {
            Intent nova_tela = new Intent(
                    GBLogicaPergunta2AN1.this, BDLogicaNiveisCrianca.class
            );
    ...
    private void abrirProximaTela(String textoSelecionado) {
        ...
        String altA = getString(R.string.texto_opcao_p2a_n1_a);
        String altB = getString(R.string.texto_opcao_p2a_n1_b);
        String altC = getString(R.string.texto_opcao_p2a_n1_c);
