...
public class CALogicaNivel1Crianca extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ca_tela_nivel_1_crianca);
        ...
        botao_voltar.setOnClickListener(v -> {
            Intent nova_tela = new Intent(
                    CALogicaNivel1Crianca.this, BDLogicaNiveisCrianca.class
            );
        ...
        botao_continuar.setOnClickListener(v -> {
            Intent nova_tela = new Intent(
                    CALogicaNivel1Crianca.this, DALogicaPergunta1N1.class
            );
            startActivity(nova_tela);
