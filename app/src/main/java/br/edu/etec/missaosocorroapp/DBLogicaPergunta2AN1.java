...
public class DBLogicaPergunta2AN1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.db_tela_pergunta_2a_n1);
        ...
        botao_voltar.setOnClickListener(v -> {
            Intent nova_tela = new Intent(
                    DBLogicaPergunta2AN1.this, BDLogicaNiveisCrianca.class
            );
