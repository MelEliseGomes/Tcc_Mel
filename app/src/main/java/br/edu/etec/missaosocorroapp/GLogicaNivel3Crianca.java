...
public class GLogicaNivel3Crianca extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.g_tela_nivel_3_crianca);
        ...
        botao_voltar.setOnClickListener(v -> {
            Intent nova_tela = new Intent(
                    GLogicaNivel3Crianca.this, DLogicaNiveisCrianca.class
            );
        ...
        botao_continuar.setOnClickListener(v -> {
            Intent nova_tela = new Intent(
                    GLogicaNivel3Crianca.this, HLogicaPergunta1.class
            );
            startActivity(nova_tela);
