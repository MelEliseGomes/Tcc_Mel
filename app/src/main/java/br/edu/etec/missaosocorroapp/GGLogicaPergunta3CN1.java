...
public class GGLogicaPergunta3CN1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.gg_tela_pergunta_3c_n1);
        ...
        botao_voltar.setOnClickListener(v -> {
            Intent nova_tela = new Intent(
                    GGLogicaPergunta3CN1.this, BDLogicaNiveisCrianca.class
            );
