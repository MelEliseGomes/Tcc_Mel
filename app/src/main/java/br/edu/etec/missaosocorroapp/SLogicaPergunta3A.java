...
public class SLogicaPergunta3A extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.s_tela_pergunta_3a_n2);
        ...
        botao_voltar.setOnClickListener(v -> {
            Intent nova_tela = new Intent(
                    SLogicaPergunta3A.this, DLogicaNiveisCrianca.class
            );
