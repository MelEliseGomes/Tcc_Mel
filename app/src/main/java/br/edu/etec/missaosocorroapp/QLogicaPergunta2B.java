...
public class QLogicaPergunta2B extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.q_tela_pergunta_2b_n2);
        ...
        botao_voltar.setOnClickListener(v -> {
            Intent nova_tela = new Intent(
                    QLogicaPergunta2B.this, DLogicaNiveisCrianca.class
            );
