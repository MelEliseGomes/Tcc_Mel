...
public class ABLogicaPontuacao extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ab_tela_pontuacao);
        ...
        botao_voltar.setOnClickListener(v -> {
            Intent nova_tela = new Intent(
                    ABLogicaPontuacao.this, BDLogicaNiveisCrianca.class
            );
        ...
        double pontosFinais = AAClassePontuacao.getTotal();
