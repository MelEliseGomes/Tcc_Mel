...
public class HCLogicaPergunta2BN2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.hc_tela_pergunta_2b_n2);
        ...
        botao_voltar.setOnClickListener(v -> {
            Intent nova_tela = new Intent(
                    HCLogicaPergunta2BN2.this, BDLogicaNiveisCrianca.class
            );
