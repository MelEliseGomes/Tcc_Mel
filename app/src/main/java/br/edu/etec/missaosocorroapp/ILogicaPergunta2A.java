...
public class ILogicaPergunta2A extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.i_tela_pergunta_2a_n1);
        ...
        botao_voltar.setOnClickListener(v -> {
            Intent nova_tela = new Intent(
                    ILogicaPergunta2A.this, DLogicaNiveisCrianca.class
            );
