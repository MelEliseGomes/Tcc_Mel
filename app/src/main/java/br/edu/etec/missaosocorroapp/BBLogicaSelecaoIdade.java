...
public class BBLogicaSelecaoIdade extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bb_tela_selecao_idade);
        ...
        botao_voltar.setOnClickListener(v -> {
            Intent nova_tela = new Intent(
                    BBLogicaSelecaoIdade.this, BALogicaBoasVindas.class
            );
        ...
        botao_crianca.setOnClickListener(v -> {
            Intent nova_tela = new Intent(
                    BBLogicaSelecaoIdade.this, BCLogicaComecarCrianca.class
            );
            startActivity(nova_tela);
