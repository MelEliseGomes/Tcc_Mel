...
public class NLogicaPergunta3C extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.n_tela_pergunta_3c_n1);
        ...
        botao_voltar.setOnClickListener(v -> {
            Intent nova_tela = new Intent(
                    NLogicaPergunta3C.this, DLogicaNiveisCrianca.class
            );
