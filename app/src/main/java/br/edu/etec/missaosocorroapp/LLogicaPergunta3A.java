...
public class LLogicaPergunta3A extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.l_tela_pergunta_3a_n1);
        ...
        botao_voltar.setOnClickListener(v -> {
            Intent nova_tela = new Intent(
                    LLogicaPergunta3A.this, DLogicaNiveisCrianca.class
            );
