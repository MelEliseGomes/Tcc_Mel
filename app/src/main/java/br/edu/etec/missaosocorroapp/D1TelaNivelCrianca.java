...
public class D1TelaNivelCrianca extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        botao_voltar.setOnClickListener(v -> {
            Intent nova_tela = new Intent(
                    D1TelaNivelCrianca.this, C1TelaCrianca.class
            );
    ...
    private void abrirTelaNivel(int nivel) {
        Intent intent = new Intent(D1TelaNivelCrianca.this, EDescricaoNiveis.class);
