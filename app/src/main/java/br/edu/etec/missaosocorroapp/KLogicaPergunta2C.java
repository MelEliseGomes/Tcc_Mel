...
public class KLogicaPergunta2C extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.k_tela_pergunta_2c_n1);
        ...
        botao_voltar.setOnClickListener(v -> {
            Intent nova_tela = new Intent(
                    KLogicaPergunta2C.this, DLogicaNiveisCrianca.class
            );
