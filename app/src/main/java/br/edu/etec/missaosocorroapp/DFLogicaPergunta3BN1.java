...
public class DFLogicaPergunta3BN1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.df_tela_pergunta_3b_n1);
        ...
        String altA = getString(R.string.texto_opcao_p3b_n1_a); // correta → tela L
        String altB = getString(R.string.texto_opcao_p3b_n1_b); // incorreta → tela M
        String altC = getString(R.string.texto_opcao_p3b_n1_c); // incorreta → tela N
        ...
        botao_voltar.setOnClickListener(v -> {
            Intent nova_tela = new Intent(
                    DFLogicaPergunta3BN1.this, BDLogicaNiveisCrianca.class
            );
    ...
    private void abrirProximaTela(String textoSelecionado) {
        ...
        String altA = getString(R.string.texto_opcao_p3b_n1_a);
        String altB = getString(R.string.texto_opcao_p3b_n1_b);
        String altC = getString(R.string.texto_opcao_p3b_n1_c);
