...
public class JLogicaPergunta2B extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.j_tela_pergunta_2b_n1);
        ...
        botao_voltar.setOnClickListener(v -> {
            Intent nova_tela = new Intent(
                    JLogicaPergunta2B.this, DLogicaNiveisCrianca.class
            );
