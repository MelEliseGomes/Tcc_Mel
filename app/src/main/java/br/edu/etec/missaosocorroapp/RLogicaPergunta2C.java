...
public class RLogicaPergunta2C extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.r_tela_pergunta_2c_n2);
        ...
        botao_voltar.setOnClickListener(v -> {
            Intent nova_tela = new Intent(
                    RLogicaPergunta2C.this, DLogicaNiveisCrianca.class
            );
