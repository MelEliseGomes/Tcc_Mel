...
public class TLogicaPergunta3B extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.t_tela_pergunta_3b_n2);
        ...
        botao_voltar.setOnClickListener(v -> {
            Intent nova_tela = new Intent(
                    TLogicaPergunta3B.this, DLogicaNiveisCrianca.class
            );
