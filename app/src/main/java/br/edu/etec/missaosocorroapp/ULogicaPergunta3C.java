...
public class ULogicaPergunta3C extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.u_tela_pergunta_3c_n2);
        ...
        botao_voltar.setOnClickListener(v -> {
            Intent nova_tela = new Intent(
                    ULogicaPergunta3C.this, DLogicaNiveisCrianca.class
            );
