...
public class FDLogicaPergunta2CN3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fd_tela_pergunta_2c_n3);
        ...
        txtPergunta.setText(getString(R.string.texto_pergunta_2c_crianca_nivel_3));

        String altA = getString(R.string.texto_opcao_p2c_n3_a); // correta → tela L
        String altB = getString(R.string.texto_opcao_p2c_n3_b); // incorreta → tela M
        String altC = getString(R.string.texto_opcao_p2c_n3_c); // incorreta → tela N
        ...
        botao_voltar.setOnClickListener(v -> {
            Intent nova_tela = new Intent(
                    FDLogicaPergunta2CN3.this, BDLogicaNiveisCrianca.class
            );
    ...
    private void abrirProximaTela(String textoSelecionado) {
        ...
        String altA = getString(R.string.texto_opcao_p2c_n3_a);
        String altB = getString(R.string.texto_opcao_p2c_n3_b);
        String altC = getString(R.string.texto_opcao_p2c_n3_c);
