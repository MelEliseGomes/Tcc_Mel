...
public class HELogicaPergunta3AN2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.he_tela_pergunta_3a_n2);
        ...
        txtPergunta.setText(getString(R.string.texto_pergunta_3a_crianca_nivel_1));

        String altA = getString(R.string.texto_opcao_p3a_n2_a); // correta → tela L
        String altB = getString(R.string.texto_opcao_p3a_n2_b); // incorreta → tela M
        String altC = getString(R.string.texto_opcao_p3a_n2_c); // incorreta → tela N
        ...
        botao_voltar.setOnClickListener(v -> {
            Intent nova_tela = new Intent(
                    HELogicaPergunta3AN2.this, BDLogicaNiveisCrianca.class
            );
    ...
    private void abrirProximaTela(String textoSelecionado) {
        ...
        String altA = getString(R.string.texto_opcao_p3a_n2_a);
        String altB = getString(R.string.texto_opcao_p3a_n2_b);
        String altC = getString(R.string.texto_opcao_p3a_n2_c);
