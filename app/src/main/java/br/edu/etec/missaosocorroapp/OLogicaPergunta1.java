...
public class OLogicaPergunta1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.o_tela_pergunta_1_n2);
        ...
        botao_voltar.setOnClickListener(v -> {
            Intent nova_tela = new Intent(
                    OLogicaPergunta1.this, DLogicaNiveisCrianca.class
            );
    ...
    private void abrirProximaTela(String textoSelecionado) {
        ...
        if (textoSelecionado.equals(altA)) {
            ...
            intent = new Intent(this, PLogicaPergunta2A.class);

        } else if (textoSelecionado.equals(altB)) {

            ZPontuacao.adicionar(0.5);
            intent = new Intent(this, QLogicaPergunta2B.class);

        } else {

            ZPontuacao.adicionar(0);
            intent = new Intent(this, RLogicaPergunta2C.class);
        }
