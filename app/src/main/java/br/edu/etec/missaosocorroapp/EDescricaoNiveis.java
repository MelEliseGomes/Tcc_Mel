...
public class EDescricaoNiveis extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.e_descricao_niveis);
        ...
        textoNivel = findViewById(R.id.txv_niveis);
