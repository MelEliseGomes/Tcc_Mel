...
public class ICLogicaPergunta2BN3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ic_tela_pergunta_2b_n3);
        ...
        botao_voltar.setOnClickListener(v -> {
            Intent nova_tela = new Intent(
                    ICLogicaPergunta2BN3.this, BDLogicaNiveisCrianca.class
            );
