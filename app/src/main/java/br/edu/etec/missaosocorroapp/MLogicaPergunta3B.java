...
public class MLogicaPergunta3B extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.m_tela_pergunta_3b_n1);
        ...
        botao_voltar.setOnClickListener(v -> {
            Intent nova_tela = new Intent(
                    MLogicaPergunta3B.this, DLogicaNiveisCrianca.class
            );
