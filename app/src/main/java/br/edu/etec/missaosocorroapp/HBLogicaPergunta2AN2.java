...
public class HBLogicaPergunta2AN2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.eb_tela_pergunta_2a_n2);
        ...
        botao_voltar.setOnClickListener(v -> {
            Intent nova_tela = new Intent(
                    HBLogicaPergunta2AN2.this, BDLogicaNiveisCrianca.class
            );
