...
public class FCLogicaPergunta2BN3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fc_tela_pergunta_2b_n3);
        ...
        txtPergunta.setText(getString(R.string.texto_pergunta_2b_crianca_nivel_3));

        String altA = getString(R.string.texto_opcao_p2b_n3_a); // correta → tela L
        String altB = getString(R.string.texto_opcao_p2b_n3_b); // incorreta → tela M
        String altC = getString(R.string.texto_opcao_p2b_n3_c); // incorreta → tela N
        ...
        botao_voltar.setOnClickListener(v -> {
            Intent nova_tela = new Intent(
                    FCLogicaPergunta2BN3.this, BDLogicaNiveisCrianca.class
            );
    ...
    private void abrirProximaTela(String textoSelecionado) {
        ...
        String altA = getString(R.string.texto_opcao_p2b_n3_a);
        String altB = getString(R.string.texto_opcao_p2b_n3_b);
        String altC = getString(R.string.texto_opcao_p2b_n3_c);
        ...
        if (textoSelecionado.equals(altA)) {
            ...
            intent = new Intent(this, FELogicaPergunta3AN3.class);

        } else if (textoSelecionado.equals(altB)) {

            AAClassePontuacao.adicionar(0.5);
            intent = new Intent(this, FFLogicaPergunta3BN3.class);

        } else {

            AAClassePontuacao.adicionar(0);
            intent = new Intent(this, FGLogicaPergunta3CN3.class);
        }
