...
public class IELogicaPergunta3AN3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ie_tela_pergunta_3a_n2);
        ...
        botao_voltar.setOnClickListener(v -> {
            Intent nova_tela = new Intent(
                    IELogicaPergunta3AN3.this, BDLogicaNiveisCrianca.class
            );
