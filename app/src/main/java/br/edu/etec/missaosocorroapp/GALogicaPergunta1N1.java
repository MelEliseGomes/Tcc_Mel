...
public class GALogicaPergunta1N1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ga_tela_pergunta_1_n1);
        ...
        txtPergunta.setText(getString(R.string.texto_pergunta_1_crianca_nivel_1));

        String altA = getString(R.string.texto_opcao_p1_n1_a); // correta → tela L
        String altB = getString(R.string.texto_opcao_p1_n1_b); // incorreta → tela M
        String altC = getString(R.string.texto_opcao_p1_n1_c); // incorreta → tela N
        ...
        botao_voltar.setOnClickListener(v -> {
            Intent nova_tela = new Intent(
                    GALogicaPergunta1N1.this, BDLogicaNiveisCrianca.class
            );
    ...
    private void abrirProximaTela(String textoSelecionado) {
        ...
        String altA = getString(R.string.texto_opcao_p1_n1_a);
        String altB = getString(R.string.texto_opcao_p1_n1_b);
        String altC = getString(R.string.texto_opcao_p1_n1_c);
        ...
        if (textoSelecionado.equals(altA)) {
            ...
            intent = new Intent(this, DBLogicaPergunta2AN1.class);

        } else if (textoSelecionado.equals(altB)) {

            AAClassePontuacao.adicionar(0.5);
            intent = new Intent(this, DCLogicaPergunta2BN1.class);

        } else {

            AAClassePontuacao.adicionar(0);
            intent = new Intent(this, DDLogicaPergunta2CN1.class);
        }
