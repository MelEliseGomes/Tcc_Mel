...
public class IBLogicaPergunta2AN3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtPergunta.setText(getString(R.string.texto_pergunta_2a_crianca_nivel_3));

        String altA = getString(R.string.texto_opcao_p2a_n3_a); // correta → tela L
        String altB = getString(R.string.texto_opcao_p2a_n3_b); // incorreta → tela M
        String altC = getString(R.string.texto_opcao_p2a_n3_c); // incorreta → tela N
        ...
        botao_voltar.setOnClickListener(v -> {
            Intent nova_tela = new Intent(
                    IBLogicaPergunta2AN3.this, BDLogicaNiveisCrianca.class
            );
    ...
    private void abrirProximaTela(String textoSelecionado) {
        ...
        String altA = getString(R.string.texto_opcao_p2a_n3_a);
        String altB = getString(R.string.texto_opcao_p2a_n3_b);
        String altC = getString(R.string.texto_opcao_p2a_n3_c);
