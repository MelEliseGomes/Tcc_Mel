...
public class WLogicaAdolescente extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.w_tela_adolescente);
        ...
        botao_voltar.setOnClickListener(v -> {
            Intent nova_tela = new Intent(
                    WLogicaAdolescente.this, BLogicaSelecaoIdade.class
            );
        ...
        botao_comecar.setOnClickListener(v -> {
            Intent nova_tela = new Intent(
                    WLogicaAdolescente.this, XLogicaNivelAdolescente.class
            );
            startActivity(nova_tela);
        });
