...
public class IGLogicaPergunta3CN3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ig_tela_pergunta_3c_n3);
        ...
        botao_voltar.setOnClickListener(v -> {
            Intent nova_tela = new Intent(
                    IGLogicaPergunta3CN3.this, BDLogicaNiveisCrianca.class
            );
