...
public class GDLogicaPergunta2CN1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.gd_tela_pergunta_2c_n1);
        ...
        botao_voltar.setOnClickListener(v -> {
            Intent nova_tela = new Intent(
                    GDLogicaPergunta2CN1.this, BDLogicaNiveisCrianca.class
            );
