...
public class XLogicaNivelAdolescente extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.x_tela_nivel_adolescente);
        ...
        botao_voltar.setOnClickListener(v -> {
            Intent nova_tela = new Intent(
                    XLogicaNivelAdolescente.this, WLogicaAdolescente.class
            );
    ...
    private void abrirTelaNivel(int nivel) {
        Intent intent = new Intent(XLogicaNivelAdolescente.this, ELogicaNivel1Crianca.class);
